...
(function(){
  ...
  var sessions = [
    ...
    { id:'s2', class_id:'c1', no:4, title:'Cân bằng tạo phức', published:true, pinned:false, held_on:'2026-09-01', created_at:d(-7*864e5),
      ...
      { id:'mm1', session_id:'s2', kind:'video', title:'Video mở đầu', order_no:10, created_at:d(-6*864e5), gioi_han_giay:0, module_id:'mod1' },
      { id:'mm2', session_id:'s2', kind:'link', title:'Bài giảng HTML tương tác', order_no:11, created_at:d(-6*864e5), xem_khong_tai:true, module_id:'mod1' },
      { id:'mm3', session_id:'s2', kind:'pdf', title:'Bài tập vận dụng nhanh', order_no:12, created_at:d(-6*864e5), module_id:'mod1' },
  ...
  /* material_contents theo đúng material_id — cho phép seed nội dung riêng từng tài liệu khi cần thử (mặc định rỗng) */
  var CONTENT_BY_ID = { mm2: { url:'https://example.com/bai-giang-tuong-tac.html', storage_path:null, body:null } };
  function qContent() {
    var matId = null, o = {};
